...
def train_online_to_offline(RL_agent,offlinereplaybuffer,onlinereplaybuffer,env, eval_env, offlineEnv, args):
    ...
    for t in range(int(args.max_timesteps)):
        ...
        if allowTrain:
            actor_loss,q_loss = RL_agent.train(offlinereplaybuffer)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--OFFline", default=3000e3, type=int)
    ...
    parser.add_argument("--max_timesteps", default=100e3, type=int)
    ...
    offlinereplaybuffer = buffer.ReplayBuffer(state_dim,action_dim,int(15e5))
    onlinereplaybuffer = []
    offlineEnv = None
